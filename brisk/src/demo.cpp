...
int main(int argc, char ** argv) {
	...
	std::cout<<tt/((double)cv::getTickFrequency()*testits)*1000.<<"ms "<<keypoints.size()<<std::endl;
	std::cout<<tt/((double)cv::getTickFrequency()*testits*(keypoints.size()))*1000<<"ms "<<std::endl;
