...
struct BriskLongPair{
	...
	public:
		...
		BriskLayer(const cv::Mat& img, uchar upperThreshold, uchar lowerThreshold, float scale=1.0f, float offset=0.0f);
		// derive a layer
	...
	{
	public:
		BriskFeatureDetector(int thresh, int octaves=3, bool suppressScaleNonmaxima=true);
